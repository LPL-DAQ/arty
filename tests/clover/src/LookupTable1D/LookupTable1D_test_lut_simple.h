...
Re-create this whenever tests/clover/src/LookupTable1D_test_simple.csv changes by running from the arty directory:
```
uv --project ~/arty/scripts run ~/arty/scripts/gen_lookup_table_1d.py test_lut_simple 2 -5.0 5.0 10.0
tests/clover/src/LookupTable1D/LookupTable1D_test_simple.csv tests/clover/src/LookupTable1D/LookupTable1D_test_lut_simple.h
```
*/
