"""
Generates a lookup table used in tests/darwin/src/LookupTable2D_test_ripples.cpp.
...
with open('tests/darwin/src/LookupTable2D/LookupTable2D_test_ripples.csv', '+w') as f:
    for row in bps:
