...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_RANGER, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TI_DP83825_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_ARTY_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RANGER_1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_RANGER_1_MIMXRT1062, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_MCUX_SNVS, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_MCUX_SNVS_SRTC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_MCUX_SNVS_SRTC_WAKE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_COUNTER_NXP_PIT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0x6767);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x6767);
