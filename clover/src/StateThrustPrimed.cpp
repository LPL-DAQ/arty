...
void StateThrustPrimed::init() {
    // Controller handles actuation now
}

std::pair<ControllerOutput, IdleData> StateThrustPrimed::tick(uint32_t current_time, uint32_t entry_time, float default_fuel, float default_lox) {
